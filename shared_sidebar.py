...
def create_sidebar(page_name=""):
    ...
    # Only create the sidebar once per page view to prevent trembling
    # This reduces re-renders that may cause the sidebar to tremble
    if sidebar_key not in st.session_state:
        ...
        with st.sidebar:
            ...
            if st.session_state.authenticated:
                ...
                with menu_container:
                    # Add button style only once to prevent CSS conflicts
                    button_style = """
                    <style>
        ...
        # If sidebar already created, just access it without recreating all elements
        with st.sidebar:
            # This ensures the sidebar container exists
            pass